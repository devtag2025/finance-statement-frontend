    ...
    >
      <div className="max-w-7xl mx-auto px-2 sm:px-6 rounded-5xl">
        <header className="flex items-center justify-between h-12 pt-6 sm:h-14 px-3 sm:px-6 relative">
          ...
          {/* Mobile Menu Button */}
          <button
            className="sm:hidden p-1 text-brand-primary relative z-50"
          ...
          {isMenuOpen && (
            <div className="absolute top-full left-0 right-0 mt-1 sm:mt-2 bg-brand-white shadow-lg rounded-lg p-3 sm:p-4 mx-2 sm:mx-6 border border-gray-100 sm:hidden z-[100]">
